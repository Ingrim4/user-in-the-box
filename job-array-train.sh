#!/bin/bash
#SBATCH --job-name=uitb-array-train
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
conda run -n uitb python uitb/train/trainer.py "configs/generated/$PREFIX/$CONFIG.yaml"

conda run -n uitb python uitb/test/evaluator.py "simulators/$CONFIG" --num_episodes 1 --action_sample_freq 100 --record --logging
conda run -n uitb python uitb/test/evaluator.py "simulators/$CONFIG" --num_episodes 100 --action_sample_freq 100 --logging
